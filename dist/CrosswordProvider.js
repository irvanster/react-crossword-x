...
exports.crosswordProviderPropTypes = {
     ...
     * typed (already massaged into upper-case)
     */
    onCellFocus: prop_types_1.default.func,
    /**
 ...
 * @since 4.0
 */
const CrosswordProvider = react_1.default.forwardRef(({ data, theme, onAnswerComplete, onAnswerCorrect, onCorrect, onAnswerIncorrect, onLoadedCorrect, onCrosswordComplete, onCrosswordCorrect, onCellChange, onCellFocus, onClueSelected, useStorage, storageKey, children, }, ref) => {
    ...
    const handleCellClick = (0, react_1.useCallback)((cellData) => {
        ...
        if (cellData.used) {
            ...
            const cellDataAll = Object.assign(Object.assign({}, data.across), data.down);
            const cellAccross = (_a = cellData.across) !== null && _a !== void 0 ? _a : '';
            const cellDown = (_b = cellData.down) !== null && _b !== void 0 ? _b : '';
            ...
            if (onCellFocus) {
                onCellFocus(Object.assign(Object.assign({}, selectedCell), { currentRow: row, currentCol: col }));
            }
        }
        focus();
